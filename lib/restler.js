...
function Request(uri, options) {
  ...
  if (this.options.multipart) {
    ...
    if ( !(this.options.data instanceof stream.Readable) && !Buffer.isBuffer(this.options.data) && typeof this.options.data == 'object') {
  ...
  run: function() {
    ...
    if (this.options.multipart) {
      ...
      if (this.options.data) {
        if( this.options.data instanceof stream.Readable){
          this.options.data.pipe(this.request);
        }else{
